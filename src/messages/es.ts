...
export const esMessages: MessageDictionary = {
  ...
  sidebar: {
    home: "Inicio",
    projects: "Proyectos",
    goodFirstIssues: "Buena Primera Issue",
    certifications: "Obtener certificaciones",
  ...
  profileEditor: {
    ...
    position: "Puesto",
    positionPlaceholder: "Buscar puestos",
    positionMax: "Máximo 3 puestos",
    positionEmpty: "Sin puestos seleccionados",
    techStack: "Tech stack",
    techStackPlaceholder: "Buscar tecnologías",
    techStackMax: "Máximo 10 tecnologías",
    techStackEmpty: "Sin tecnologías seleccionadas",
