          ...
          {DEFAULT_TECH_RANKING_TAGS.map((tag) => (
            <button
              ...
              className={`rounded-lg border px-3 py-1.5 text-xs transition ${
                tech === tag
                  ? "surface-outline-accent border-orange-500/40 bg-orange-500/12 text-orange-300"
                  : "surface-subcard border-white/20 bg-neutral-900 text-gray-200 hover:border-orange-500/35 hover:text-orange-300"
              }`}
            >
              {tag}
            </button>
